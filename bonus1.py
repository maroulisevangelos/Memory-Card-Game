...
def playgame():
    ...
    print("Αν παίξετε με τον κλασσικό τρόπο πληκτρολογείστε K")
    print("Αν παίξετε με τον μη κλασσικό τρόπο πληκτρολογείστε MK, οπότε θα παίρνετε πόντους και όταν τα φύλλα που ανοίχτηκαν ανήκουν στην ίδια σειρά ")
    epilogi=str(input('δώσε K για το κλασσικό Matching Game ή δώσε MK για επιπλέον πόντους '))
    print()
    ...
    epipedo = int(input( 'Δώστε επίπεδο δυσκολίας: 1(εύκολο με 16 κάρτες) ή 2 (μέτριο με 40 κάρτες) ή 3(δύσκολο με 52 κάρτες) :   '))
    ...
    if epipedo == 1:
        ...
        while found < 16:
            ...
            firstpositionst = int(input("Δώσε στήλη πρώτης κάρτας στον πίνακα των καρτών, από 1-4 "))
            ...
            while (firstpositiongr not in range(1, 5) or firstpositionst not in range(1, 5)) or state16[firstposition] != 'X ':
                ...
                ekt16()
                firstpositiongr = int(input("Δώσε γραμμή πρώτης κάρτας στον πίνακα των καρτών από 1-4 "))
                firstpositionst = int( input("Δώσε στήλη πρώτης κάρταςστον πίνακα των καρτών από 1-4 "))
                firstposition = (firstpositiongr-1)*4 + (firstpositionst-1)
            ...
            secondpositionst = int(input("Δώσε στήλη δεύτερης κάρτας στον πίνακα των καρτών, από 1-4 "))
            ...
            print(gameDeck1._deck[firstposition], '   ', gameDeck1._deck[secondposition])
            if gameDeck1._deck[firstposition][0]==gameDeck1._deck[secondposition][0]:
                    ...
                    thirdpositionst = int( input("Δώσε στήλη τρίτης κάρταςστον πίνακα των καρτών από 1-4 "))
                    ...
                    while (thirdpositiongr not in range(1, 5) or thirdpositionst not in range(1, 5)) or state16[thirdposition] != 'X ' or (firstposition == thirdposition or secondposition == thirdposition):
                            ...
                            print()
                            ekt16()
                            thirdpositiongr = int(input("Δώσε γραμμή δεύτερης κάρτας στον πίνακα των καρτών από 1-4 "))
                            thirdpositionst = int(input("Δώσε στήλη δεύτερης κάρτας στον πίνακα των καρτών από 1-4 "))
                            thirdposition = (thirdpositiongr-1) * 4 + (thirdpositionst-1)
                    ...
                    if (gameDeck1._deck[thirdposition][0] == 'Q' or gameDeck1._deck[thirdposition][0] == 'K'):
                        ...
                        ekt16()
                         ...
                         if ((gameDeck1._deck[firstposition][1]==gameDeck1._deck[thirdposition][1]) and gameDeck1._deck[firstposition][1]!='0') or (gameDeck1._deck[thirdposition][1]=='0' and gameDeck1._deck[firstposition][1]==gameDeck1._deck[thirdposition][2]) or (gameDeck1._deck[firstposition][1]=='0' and gameDeck1._deck[firstposition][2]==gameDeck1._deck[thirdposition][1]) or (gameDeck1._deck[thirdposition][1]==gameDeck1._deck[secondposition][1]) or (gameDeck1._deck[secondposition][1]=='0' and gameDeck1._deck[thirdposition][1]==gameDeck1._deck[secondposition][2]) or (gameDeck1._deck[thirdposition][1]=='0' and gameDeck1._deck[thirdposition][2]==gameDeck1._deck[secondposition][1]):
                            pontoi=20
                            print("πέτυχες ίδια σειρά στις δύο κάρτες που άνοιξες")
                            scor[paiktis-1]=scor[paiktis-1]+ pontoi
                            print("οι πόντοι συνολικά είναι: ")
                            print(scor)
                            print("αντίστοιχα με τους παίκτες μας:")
                            print(names)
                            if ((gameDeck1._deck[firstposition][1]==gameDeck1._deck[thirdposition][1]) and gameDeck1._deck[firstposition][1]!='0') or (gameDeck1._deck[thirdposition][1]=='0' and gameDeck1._deck[firstposition][1]==gameDeck1._deck[thirdposition][2]) or (gameDeck1._deck[firstposition][1]=='0' and gameDeck1._deck[firstposition][2]==gameDeck1._deck[thirdposition][1]):
                                state16[secondposition] ='X '
                            elif  (gameDeck1._deck[thirdposition][1]==gameDeck1._deck[secondposition][1]) or (gameDeck1._deck[secondposition][1]=='0' and gameDeck1._deck[thirdposition][1]==gameDeck1._deck[secondposition][2]) or (gameDeck1._deck[thirdposition][1]=='0' and gameDeck1._deck[thirdposition][2]==gameDeck1._deck[secondposition][1]):
                                state16[firstposition] ='X '
                            found=found+2
                            ekt16()
                         else:
                ...
                state16[secondposition] = 'X '
            if epilogi=="MK":
                        if ((gameDeck1._deck[firstposition][1]==gameDeck1._deck[secondposition][1]) and gameDeck1._deck[firstposition][1]!='0') or (gameDeck1._deck[secondposition][1]=='0' and gameDeck1._deck[firstposition][1]==gameDeck1._deck[secondposition][2]) or (gameDeck1._deck[firstposition][1]=='0' and gameDeck1._deck[firstposition][2]==gameDeck1._deck[secondposition][1]):
                            pontoi=20
                            print("πέτυχες ίδια σειρά στις δύο κάρτες που άνοιξες")
                            scor[paiktis-1]=scor[paiktis-1]+ pontoi
                            print("οι πόντοι συνολικά είναι: ")
        ...
        while (found<40 and paiktis<=n):
            ...
            if epilogi=="MK":
                        if (gameDeck2._deck[firstposition][1]==gameDeck2._deck[secondposition][1]  and gameDeck2._deck[firstposition][1]!='0') or (gameDeck2._deck[secondposition][1]=='0' and gameDeck2._deck[firstposition][1]==gameDeck2._deck[secondposition][2]) or (gameDeck2._deck[firstposition][1]=='0' and gameDeck2._deck[firstposition][2]==gameDeck2._deck[secondposition][1]):
                            if gameDeck2._deck[firstposition][1]=='0':
                                pontoi=10+int(gameDeck2._deck[secondposition][0])
                            elif gameDeck2._deck[secondposition][1]=='0':
                                pontoi=10+int(gameDeck2._deck[firstposition][0])
                            else:
                                c1=Card(gameDeck2._deck[firstposition][0],gameDeck2._deck[firstposition][1])
                                c2=Card(gameDeck2._deck[secondposition][0],gameDeck2._deck[secondposition][1])
                                pontoi=int(c1.axia)+int(c2.axia)
                            print("πέτυχες ίδια σειρά στις δύο κάρτες που άνοιξες")
                            scor[paiktis-1]=scor[paiktis-1]+ pontoi
                            print("οι πόντοι συνολικά είναι: ")
                            print(scor)
        ...
        while found<52 :
            ...
            ekt52()
            if  ((gameDeck3._deck[firstposition][0]=='Q' and gameDeck3._deck[secondposition][0]=='K') or (gameDeck3._deck[firstposition][0]=='K' and gameDeck3._deck[secondposition][0]=='Q')):
                    print("άνοιξες μία ντάμα και ένα Ρήγα! Μπορείς να ανοίξεις και μια τρίτη κάρτα")
                    thirdpositiongr=int(input("Δώσε γραμμή τρίτης κάρτας στον πίνακα των καρτών από 1-4 "))
            ...
            if gameDeck3._deck[firstposition][0]==gameDeck3._deck[secondposition][0]:
                    ...
                    if epilogi=="MK":
                        if (gameDeck3._deck[firstposition][2]==gameDeck3._deck[secondposition][2]) or (gameDeck3._deck[secondposition][2]=='0' and gameDeck3._deck[firstposition][2]==gameDeck3._deck[secondposition][3]) or (gameDeck3._deck[firstposition][2]=='0' and gameDeck3._deck[firstposition][3]==gameDeck3._deck[secondposition][2]):
                            if gameDeck3._deck[firstposition][1]=='0':
                                pontoi=10+int(gameDeck2._deck[secondposition][0])
                            elif gameDeck3._deck[secondposition][1]=='0':
                                pontoi=10+int(gameDeck2._deck[firstposition][0])
                            else:
                                c1=Card(gameDeck3._deck[firstposition][0],gameDeck3._deck[firstposition][1])
                                c2=Card(gameDeck3._deck[secondposition][0],gameDeck3._deck[secondposition][1])
                                pontoi=int(c1.axia)+int(c2.axia)
                            print("πέτυχες ίδια σειρά στις δύο κάρτες που άνοιξες")
                            scor[paiktis-1]=scor[paiktis-1]+ pontoi
                            print("οι πόντοι συνολικά είναι: ")
